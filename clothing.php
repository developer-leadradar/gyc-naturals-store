...
<section style="position:relative;overflow:hidden;min-height:480px;display:flex;align-items:center;background:#1a1a2e;">
  <div style="position:absolute;inset:0;background-image:url('https://images.pexels.com/photos/1536619/pexels-photo-1536619.jpeg?auto=compress&cs=tinysrgb&w=1400');background-size:cover;background-position:center top;opacity:.38;"></div>
  ...
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:3.5rem;align-items:center;">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;">
        <img src="https://images.pexels.com/photos/2220316/pexels-photo-2220316.jpeg?auto=compress&cs=tinysrgb&w=400"
  ...
  <div class="container">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:1.5rem;">
      <?php foreach ($clothingItems as $item):
        $img      = $item['image'] ?? 'https://images.pexels.com/photos/2220316/pexels-photo-2220316.jpeg?auto=compress&cs=tinysrgb&w=400';
