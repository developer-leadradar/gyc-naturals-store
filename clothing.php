  ...
  <div class="container">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:1.5rem;">
      <?php foreach ($clothingItems as $item):
        $img      = $item['image'] ?? 'https://images.pexels.com/photos/952630/pexels-photo-952630.jpeg?auto=compress&cs=tinysrgb&w=400';
...
<section style="padding:4rem 0;background:#F8FAF9;">
  <div class="container" style="max-width:720px;">
    ...
    <div class="clothing-size-card" style="background:#fff;border-radius:var(--gyc-radius-xl);overflow:hidden;box-shadow:0 2px 20px rgba(0,0,0,.06);">
      <table class="clothing-size-table" style="width:100%;border-collapse:separate;border-spacing:0;font-size:.875rem;table-layout:fixed;">
        <thead>
