    ...
    <div class="dash-grid">
      ...
      <div>
        ...
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:1rem;margin-bottom:2rem;">
          <?php
          $quickActions = [
            ['icon' => 'shopping-bag',   'label' => 'Shop',         'url' => SITE_URL . '/shop.php',               'color' => 'var(--gyc-green-700)'],
            ['icon' => 'calendar-check', 'label' => 'Book',         'url' => SITE_URL . '/book-appointment.php',   'color' => 'var(--gyc-gold-600)'],
          ...
          ?>
          <a href="<?= $qa['url'] ?>"
             style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:.5rem;padding:1.25rem;background:#fff;border:1.5px solid var(--gyc-green-100);border-radius:var(--gyc-radius-lg);text-decoration:none;font-size:.82rem;font-weight:600;color:var(--gyc-dark);transition:border-color .15s,box-shadow .15s;"
